...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('-cascades', type=int, default=4,help='number of NN in WINN')
        self.parser.add_argument('-neg_init_images_count', type=int, default=10000,help='number of initial negative images')
        ...
        self.parser.add_argument('-lr_gen', type=float, default=1e-4,help='learning rate of generator')
        ...
        self.parser.add_argument('-langevin_step_num_dis', type=int, default=2000, help='langevin step number for discriminator')
