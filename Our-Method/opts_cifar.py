...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('-img_size', type=int, default=32, help='output image size')
        ...
        self.parser.add_argument('-category', default='planes', help='training category')
        self.parser.add_argument('-data_path', default='./data/cifar10', help='path to data')
        ...
        self.parser.add_argument('-ckpt_gen', default='./checkpoint/generator.model', help='load checkpoint for generator')
        ...
        self.parser.add_argument('-lr_gen', type=float, default=5e-3,help='learning rate of generator')
        self.parser.add_argument('-beta1_gen', type=float, default=0.5,help='beta of Adam for generator')

        #Descriptor Parameters
        self.parser.add_argument('-ckpt_dis', default='./checkpoint/discriminator.model', help='load checkpoint for discriminator')
